      ...
      <DiscordLayout>
        <div className="p-8">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
            <div>
              <h1 className="text-2xl font-semibold text-gray-900 mb-2">メンバー管理</h1>
          ...
          {myProfile && (
            <div className="bg-white rounded-xl shadow-sm p-6 mb-6 border border-gray-200">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">自分のプロフィール</h2>
          ...
          <div className="bg-white rounded-lg p-4 shadow-sm border border-gray-200 mb-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">部署で絞り込み</label>
                <select
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">グループで絞り込み</label>
                <select
                  value={filterGroup}
